...
import {Container, Row, Col, Spacer, Button, Grid} from "@nextui-org/react";
...
const Hero: React.FC = () => {
  ...
  const handleGetStartedClick = () => {
    router.push('/docs/portofolio/seo/intro');
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <StyledTitle css={{mb: 0}}>Where every&nbsp;</StyledTitle>
          <StyledGradientTitle css={{mb: 0}}>byte&nbsp;</StyledGradientTitle>
          <StyledTitle css={{mb: 0, "@xsMax": {d: "inline-block"}}}>
            counts towards your digital success.
          </StyledTitle>

          <StyledSubtitle className="hero__text-subtitle">
            Every byte, every growth.
          </StyledSubtitle>
          <Spacer y={1.5} />
          <Grid.Container
            alignItems="center"
